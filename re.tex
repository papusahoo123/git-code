...
if i  have a one project1 in( https://github.com/papusahoo123/len.git) repo i want to  add  diffent  repo -> https://github.com/papusahoo123/project3.git or https://github.com/papusahoo123/new1.git
fist see the cuurrnt stage 
-> git remote -v 
origin  https://github.com/papusahoo123/len.git (fetch)
origin  https://github.com/papusahoo123/len.git (push)

i want add diffent repo -> https://github.com/papusahoo123/project3.git or https://github.com/papusahoo123/new1.git
-> git remote set-url origin https://github.com/papusahoo123/project3.git
then cheak it swich one repo to anthor -> git remote -v

-> git remote remove origin
-> git remote add origin  https://github.com/papusahoo123/project3.git
